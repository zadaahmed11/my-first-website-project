...
export default function Home({ productsData }) {
  ...
  // دالة لتنظيف اسم المنتج من أي كلمات مكررة
  ...
  return (
    <div className="bg-stone-50 min-h-screen text-stone-800 pb-20">
      ...
      <div className="container mx-auto px-4 py-10">
        {/* فلاتر الأقسام المترجمة الفورية */}
        ...
        {/* شبكة المنتجات العريضة والكاملة الممتدة على كامل عرض الصفحة بدون العربة الجانبية المزعجة */}
