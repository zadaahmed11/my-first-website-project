      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-stone-400 mt-1 font-medium">
              Pure nature and authentic quality straight to your doorstep
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6">
          <div className="hidden lg:flex items-center gap-4 text-xs font-semibold text-stone-500">
            ...
            <span>Fast, securely sealed shipping 📦</span>
          </div>


          <button 
            onClick={toggleLanguage}
            className="bg-emerald-50 text-emerald-800 border border-emerald-100 px-3.5 py-1.5 rounded-lg text-xs font-bold hover:bg-emerald-100 transition-all"
          >
          ...
          <div 
            className="relative p-2 bg-stone-50 hover:bg-emerald-50 rounded-xl cursor-pointer text-stone-700 hover:text-emerald-800 transition-all"
